...
function loadAndSortTowns() {
  return fetch('https://raw.githubusercontent.com/smelukov/citiesTest/master/cities.json').then((res) => res.json()).then((towns) => towns.sort((a, b) => a.name.localeCompare(b.name)));
}
